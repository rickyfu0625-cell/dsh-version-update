...
// 发现新版本时出现「立即更新」按钮，点击后在终端中打开升级命令（前台可见进度），完成后提示重启 dsh。中英双语，跟随主题变量。
	...
	factory: (require) => {
		...
		const STRINGS = {
			zh: {
				...
				update: "立即更新",
				updating: "打开终端中…",
				updateOpened: "升级命令已在终端中打开",
				restartHint: "完成后请重启 dsh 生效",
				updateFailed: "更新失败"
			},
			en: {
				title: "Version",
				...
				update: "Update now",
				updating: "Opening terminal…",
				updateOpened: "Update command opened in terminal",
				restartHint: "Restart dsh after it completes",
